            ...
            <div className="footer-shipping pt-60 pb-55 pb-xs-25">
                <div className="row">
                    <div className="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div className="li-shipping-inner-box">
                            <div className="shipping-icon">
                                <img src="/luana/images/shipping-icon/1.png" alt="Shipping Icon"/>
                            </div>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div className="li-shipping-inner-box">
                            <div className="shipping-icon">
                                <img src="/luana/images/shipping-icon/2.png" alt="Shipping Icon"/>
                            </div>
                            <div className="shipping-text">
                                <h2>Safe Payment</h2>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div className="li-shipping-inner-box">
                            <div className="shipping-icon">
                                <img src="/luana/images/shipping-icon/3.png" alt="Shipping Icon"/>
                            </div>
                            <div className="shipping-text">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div className="li-shipping-inner-box">
                            <div className="shipping-icon">
                                <img src="/luana/images/shipping-icon/4.png" alt="Shipping Icon"/>
                            </div>
                            <div className="shipping-text">
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="footer-logo">
                            <img src="/luana/images/menu/logo/1.jpg" alt="Footer Logo"/>
                            <p className="info">
            ...
            <div className="row">
                <div className="col-lg-12">
                    ...
                    <div className="copyright text-center">
                        <a href="#">
                            <img src="/luana/images/payment/1.png" alt=""/>
                        </a>
                    </div>
